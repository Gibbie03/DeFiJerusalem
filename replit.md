...
- **Blacklist Management**: Dedicated Blacklist page shows all automatically and manually blacklisted protocols with severity levels, threat details, and reasons. Blacklist entries include status tracking (ACTIVE/INACTIVE) and timestamps.
